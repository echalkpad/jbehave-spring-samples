...
public class ConfigurableReportintSpringJUnit4ClassRunner extends SpringJUnit4ClassRunner
	{
	...
	public ConfigurableReportintSpringJUnit4ClassRunner(Class<? extends ConfigurableEmbedder> testClass)
			throws Throwable {
		super(testClass);
