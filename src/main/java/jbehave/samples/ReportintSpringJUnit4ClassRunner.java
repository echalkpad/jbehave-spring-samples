...
public class ReportintSpringJUnit4ClassRunner extends SpringJUnit4ClassRunner {
	...
	public ReportintSpringJUnit4ClassRunner(Class<? extends ConfigurableEmbedder> testClass)
			throws Throwable {
		super(testClass);
