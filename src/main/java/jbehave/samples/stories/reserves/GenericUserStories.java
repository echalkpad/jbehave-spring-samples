...
public abstract class GenericUserStories extends JUnitStories {
    
    public GenericUserStories() {
        configuredEmbedder().embedderControls().doGenerateViewAfterStories(true).doIgnoreFailureInStories(false)
                .doIgnoreFailureInView(false).useStoryTimeoutInSecs(60);
       // configuredEmbedder().useMetaFilters(Lists.newArrayList("-content Financial"));
    }
